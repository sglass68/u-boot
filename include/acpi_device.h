 ...
 * @return 0 if OK, -ve on error
 */
int acpi_device_write_gpio_desc(struct acpi_ctx *ctx, const struct gpio_desc *desc);
...
/**
 * I2C Human-Inteface Devices configuration
 *
 ...
 */
int gpio_get_acpi(const struct gpio_desc *desc,
